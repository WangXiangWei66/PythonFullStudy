'''本代码基于LangChain框架构建的旅行服务助手系统，主要功能时处理航班、酒店、租车和旅行游览等玉帝哦那个及相关操作'''
from datetime import datetime
from langchain_core.prompts.chat import ChatPromptTemplate
from ctrip.graph_chat.base_data_model import CompleteOrEscalate
from ctrip.graph_chat.llm_travily import llm
from ctrip.tools.car_tools import book_car_rental, search_car_rentals, update_car_rental, cancel_car_rental
