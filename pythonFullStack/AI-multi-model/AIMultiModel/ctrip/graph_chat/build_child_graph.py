'''基于 LangChain 相关库构建了携程旅行服务中不同业务（航班、租车、酒店、游览）的子工作流状态图，用于管理和处理相应的预订及更新等操作。'''
from langchain_core.messages.tool import ToolMessage
from langgraph.constants import END
from langgraph.graph import StateGraph
from langgraph.prebuilt import tools_condition
from ctrip.graph_chat.agent_assistant import update_flight_runnable, update_flight_sensitive_tools, \
    update_flight_safe_tools, book_car_rental_runnable, book_car_rental_safe_tools, book_car_rental_sensitive_tools, \
    book_hotel_runnable, book_hotel_safe_tools, book_hotel_sensitive_tools, book_excursion_runnable, \
    book_excursion_safe_tools, book_excursion_sensitive_tools
from ctrip.graph_chat.assistant import CtripAssistant
from ctrip.graph_chat.base_data_model import CompleteOrEscalate
from ctrip.graph_chat.entry_node import create_entry_node
from ctrip.tools.tools_handler import create_tool_node_with_fallback
